...
# Initialise a vector L of likelihoods for each site. At the end, we'll find the product of all L's components.
L = c(rep(0,seq.length))
# Temp vectors for use later.
Tmp_probs_i = c(rep(0,4))
Tmp_probs_k = c(rep(0,4))

# Now set up our likelihood function! Do this in a similar way to slide 18 (?).
